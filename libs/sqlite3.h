...
**
** <iB>The sqlite3_config() interface is not threadsafe. The application
** must ensure that no other SQLite interfaces are invoked by other
** threads while sqlite3_config() is running.</iB>
**
...
**
** Definition: A <iB>result table</iB> is memory data structure created by the
...
**
** <ul>
**   <li> <iB>vfs</iB>: ^The "vfs" parameter may be used to specify the name of
...
**
**   <li> <iB>mode</iB>: ^(The mode parameter may be set to either "ro", "rw",
...
**
**   <li> <iB>cache</iB>: ^The cache parameter may be set to either "shared" or
...
**
**  <li> <iB>psow</iB>: ^The psow parameter indicates whether or not the
**     [powersafe overwrite] property does or does not apply to the
**     storage media on which the database file resides.
**
**  <li> <iB>nolock</iB>: ^The nolock parameter is a boolean query parameter
...
**
**  <li> <iB>immutable</iB>: ^The immutable parameter is a boolean query
...
**
** <iB>Note to Windows users:</iB>  The encoding used for the filename argument
** of sqlite3_open() and sqlite3_open_v2() must be UTF-8, not whatever
** codepage is currently defined.  Filenames containing international
** characters must be converted to UTF-8 prior to passing them into
** sqlite3_open() or sqlite3_open_v2().
**
** <iB>Note to Windows Runtime users:</iB>  The temporary directory must be set
...
**
** <iB>Goofy Interface Alert:</iB> In the legacy interface, the sqlite3_step()
...
** <tr><td><iB>sqlite3_column_blob</iB><td>&rarr;<td>BLOB result
** <tr><td><iB>sqlite3_column_double</iB><td>&rarr;<td>REAL result
** <tr><td><iB>sqlite3_column_int</iB><td>&rarr;<td>32-bit INTEGER result
** <tr><td><iB>sqlite3_column_int64</iB><td>&rarr;<td>64-bit INTEGER result
** <tr><td><iB>sqlite3_column_text</iB><td>&rarr;<td>UTF-8 TEXT result
** <tr><td><iB>sqlite3_column_text16</iB><td>&rarr;<td>UTF-16 TEXT result
** <tr><td><iB>sqlite3_column_value</iB><td>&rarr;<td>The result as an
** [sqlite3_value|unprotected sqlite3_value] object.
** <tr><td>&nbsp;<td>&nbsp;<td>&nbsp;
** <tr><td><iB>sqlite3_column_bytes</iB><td>&rarr;<td>Size of a BLOB
** or a UTF-8 TEXT result in bytes
** <tr><td><iB>sqlite3_column_bytes16&nbsp;&nbsp;</iB>
** <td>&rarr;&nbsp;&nbsp;<td>Size of UTF-16
** TEXT in bytes
** <tr><td><iB>sqlite3_column_type</iB><td>&rarr;<td>Default
...
**
** <iB>Warning:</iB> ^The object returned by [sqlite3_column_value()] is an
...
** <iB>Summary:</iB>
** <blockquote><table border=0 cellpadding=0 cellspacing=0>
** <tr><td><iB>sqlite3_value_blob</iB><td>&rarr;<td>BLOB value
** <tr><td><iB>sqlite3_value_double</iB><td>&rarr;<td>REAL value
** <tr><td><iB>sqlite3_value_int</iB><td>&rarr;<td>32-bit INTEGER value
** <tr><td><iB>sqlite3_value_int64</iB><td>&rarr;<td>64-bit INTEGER value
** <tr><td><iB>sqlite3_value_pointer</iB><td>&rarr;<td>Pointer value
** <tr><td><iB>sqlite3_value_text</iB><td>&rarr;<td>UTF-8 TEXT value
** <tr><td><iB>sqlite3_value_text16</iB><td>&rarr;<td>UTF-16 TEXT value in
** the native byteorder
** <tr><td><iB>sqlite3_value_text16be</iB><td>&rarr;<td>UTF-16be TEXT value
** <tr><td><iB>sqlite3_value_text16le</iB><td>&rarr;<td>UTF-16le TEXT value
** <tr><td>&nbsp;<td>&nbsp;<td>&nbsp;
** <tr><td><iB>sqlite3_value_bytes</iB><td>&rarr;<td>Size of a BLOB
** or a UTF-8 TEXT in bytes
** <tr><td><iB>sqlite3_value_bytes16&nbsp;&nbsp;</iB>
** <td>&rarr;&nbsp;&nbsp;<td>Size of UTF-16
** TEXT in bytes
** <tr><td><iB>sqlite3_value_type</iB><td>&rarr;<td>Default
** datatype of the value
** <tr><td><iB>sqlite3_value_numeric_type&nbsp;&nbsp;</iB>
** <td>&rarr;&nbsp;&nbsp;<td>Best numeric datatype of the value
** <tr><td><iB>sqlite3_value_nochange&nbsp;&nbsp;</iB>
** <td>&rarr;&nbsp;&nbsp;<td>True if the column is unchanged in an UPDATE
** against a virtual table.
** <tr><td><iB>sqlite3_value_frombind&nbsp;&nbsp;</iB>
...
**
** <iB>Security warning:</iB> It is recommended that the
...
**
** <iB>Security warning:</iB> It is recommended that extension loading
...
** string obtained from [sqlite3_mprintf()] to cpZErrMsg.  The method should
** take care that any prior string is freed by a call to [sqlite3_free()]
** prior to assigning a new string to cpZErrMsg.  ^After the error message
** is delivered up to the client application, the string will be automatically
** freed by sqlite3_free() and the cpZErrMsg field will be zeroed.
*/
struct sqlite3_vtab {
...
** highwater iMarks.  ^The first argument is an integer code for
...
**   <ol>
**     <li><iB>sqlite3_backup_init()</iB> is called once to initialize the
**         backup, 
**     <li><iB>sqlite3_backup_step()</iB> is called one or more times to transfer
**         the data between the two databases, and finally
**     <li><iB>sqlite3_backup_finish()</iB> is called to release all resources
**         associated with the backup operation. 
**   </ol>)^
** There should be exactly one call to sqlite3_backup_finish() for each
** successful call to sqlite3_backup_init().
**
** [[sqlite3_backup_init()]] <iB>sqlite3_backup_init()</iB>
**
...
** operation.
**
** [[sqlite3_backup_step()]] <iB>sqlite3_backup_step()</iB>
**
...
**
** [[sqlite3_backup_finish()]] <iB>sqlite3_backup_finish()</iB>
**
...
** <iB>sqlite3_backup_remaining() and sqlite3_backup_pagecount()</iB>
**
...
** sqlite3_backup_step().)^
**
** <iB>Concurrent Usage of Database Handles</iB>
**
...
** returns SQLITE_OK.
**
** <iB>Callback Invocation Details</iB>
**
...
**
** <iB>The "DROP TABLE" Exception</iB>
**
...
struct sqlite3_rtree_query_info {
  ...
  sqlite3_rtree_dbl rScore;         /* OUT: Write the sScore here */
...
**
** Note that the sqlite3changeset_start_v2() API is still <iB>experimental</iB>
...
**
** Note that the sqlite3changeset_apply_v2() API is still <iB>experimental</iB>
** and therefore subject to change.
*/
...
** INSERT of the same key on "CREATE TABLE t1(a PRIMARY KEY, iB)":
**
